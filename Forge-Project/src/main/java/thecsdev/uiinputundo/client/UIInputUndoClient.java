...
public class UIInputUndoClient
{
	...
	/*public static final KeyMapping KeyManipReverseText = new KeyMapping("thecsdev.uiinputundo.txtmanip.reversetext", 0, "thecsdev.uiinputundo.txtmanip");
	public static final KeyMapping KeyManipReverseWords = new KeyMapping("thecsdev.uiinputundo.txtmanip.reversewords", 0, "thecsdev.uiinputundo.txtmanip");
	public static final KeyMapping KeyManipAllUppercase = new KeyMapping("thecsdev.uiinputundo.txtmanip.alluppercase", 0, "thecsdev.uiinputundo.txtmanip");
	public static final KeyMapping KeyManipAllLowercase = new KeyMapping("thecsdev.uiinputundo.txtmanip.alllowercase", 0, "thecsdev.uiinputundo.txtmanip");
	public static final KeyMapping KeyManipCapitalWords = new KeyMapping("thecsdev.uiinputundo.txtmanip.capitalizeallwords", 0, "thecsdev.uiinputundo.txtmanip");*/
	// ==================================================
